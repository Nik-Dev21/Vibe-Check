...
/**
 * Returns a valid IBM IAM Bearer token for watsonx.ai.
 * Uses WATSONX_API_KEY exclusively — other IBM services (Cloudant, COS, NLU)
 * manage their own auth via their SDK IamAuthenticators.
